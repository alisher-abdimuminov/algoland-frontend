...
export function generateRandomSlice(length: number): string {
...
export function encode(str: string, key: string = secretKey, sliceLength: number = 8): string {
...
export function decode(encodedStr: string, key: string = secretKey, sliceLength: number = 8): string {
    try {
...
export function jsonify<T>(data: string) {
    try {
