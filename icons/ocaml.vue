<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 128 128">
        <defs>
            <linearGradient id="deviconOcaml0" x1="82.925" x2="82.925" y1="97.718" y2="97.9"
                gradientTransform="translate(0 8.224)scale(.77317)" gradientUnits="userSpaceOnUse">
                <stop offset="0" stop-color="#f29100" />
                <stop offset="1" stop-color="#ec670f" />
            </linearGradient>
            <linearGradient id="deviconOcaml1" x1="61.276" x2="61.276" y1="98.981" y2="144.277"
                gradientTransform="translate(0 8.224)scale(.77317)" gradientUnits="userSpaceOnUse">
                <stop offset="0" stop-color="#f29100" />
                <stop offset="1" stop-color="#ec670f" />
            </linearGradient>
            <linearGradient id="deviconOcaml2" x1="82.781" x2="82.781" y1="0" y2="144.245"
                gradientTransform="translate(0 8.224)scale(.77317)" gradientUnits="userSpaceOnUse">
                <stop offset="0" stop-color="#f29100" />
                <stop offset="1" stop-color="#ec670f" />
            </linearGradient>
            <linearGradient id="deviconOcaml3" x1="22.871" x2="22.871" y1="92.114" y2="143.249"
                gradientTransform="translate(0 8.224)scale(.77317)" gradientUnits="userSpaceOnUse">
                <stop offset="0" stop-color="#f29100" />
                <stop offset="1" stop-color="#ec670f" />
            </linearGradient>
        </defs>
        <path fill="#484444" d="m64.11 83.918l.019-.047c-.027-.117-.035-.148-.02.047zm0 0" />
        <path fill="url(#deviconOcaml0)" d="m64.11 83.918l.019-.047c-.027-.117-.035-.148-.02.047zm0 0" />
        <path fill="url(#deviconOcaml1)"
